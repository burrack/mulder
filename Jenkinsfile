pipeline {
  ...
  stages {
    stage('CI Build and push snapshot') {
      ...
      steps {
        container('go') {
          dir('/home/jenkins/go/src/github.com/burrack/mulder') {
            checkout scm
            sh "make test-unit"
            sh "make linux"
          ...
          dir('/home/jenkins/go/src/github.com/burrack/mulder/charts/mulder') {
            sh "jx step helm build"
          }
          dir('/home/jenkins/go/src/github.com/burrack/mulder/charts/preview') {
            sh "make preview"
